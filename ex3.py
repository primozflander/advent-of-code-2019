...
for string in input1:
    dir1.append(string[0])
    val1.append(string[1:])

print('direction1: ', dir1)
print('value1: ', val1)

dir2 = list()
val2 = list()
for string in input2:
    dir2.append(string[0])
    val2.append(string[1:])

print('direction2: ', dir2)
print('value2: ', val2)
'''
x = list()
y = list()
